...
import { TrendingUp, Users, DollarSign, Calendar, ToggleLeft } from 'lucide-react';
...
const CohortAnalysis: React.FC = () => {
  ...
  return (
    <AppLayout loading={loading} loadingMessage="Loading cohort analysis...">
      <PageHeader
        title="Cohort Analysis"
        description="Track customer behavior and revenue patterns across different signup cohorts"
        onRefresh={loadData}
        loading={loading}
        actions={
